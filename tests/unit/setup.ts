// Runs before every unit test file. Provides valid defaults for every
// required env var so modules that eagerly validate env at import time
// (src/lib/env.ts) don't blow up unrelated tests. Tests that specifically
// exercise env validation call loadEnv() directly with their own fixtures
